...
Player.prototype.dropLastItem = function() {
  return this.items.pop(); // Remove and return the last item
};

// Drop the last item for player1
var droppedItem = player1.dropLastItem();
console.log(player1.name + " dropped: " + droppedItem);

// Show player1's info again to see updated items
player1.showInfo("=");
